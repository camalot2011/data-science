...
for (t in unique(trades_processed_boll$ticker)) {
    if ((max(tail(t$BBands,5*flat_weeks))< (1+price_fluctuation) * t$BBands[length(t$BBands)-5*flat_weeks]) & (min(tail(t$BBands,5*flat_weeks)) > (1-price_fluctuation) * t$BBands[length(t$BBands)-5*flat_weeks])) {
